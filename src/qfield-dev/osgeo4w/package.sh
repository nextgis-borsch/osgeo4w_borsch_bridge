...
(
	...
	export INCLUDE="$(cygpath -aw $OSGEO4W_ROOT/apps/qgis-dev/include);$(cygpath -aw $OSGEO4W_ROOT/apps/Qt6/include);$(cygpath -aw $OSGEO4W_ROOT/apps/gdal-dev/include);$(cygpath -aw $OSGEO4W_ROOT/include);$INCLUDE"
	export LIB="$(cygpath -aw $OSGEO4W_ROOT/apps/qgis-dev/lib);$(cygpath -aw $OSGEO4W_ROOT/apps/Qt6/lib);$(cygpath -aw $OSGEO4W_ROOT/apps/gdal-dev/lib);$(cygpath -aw $OSGEO4W_ROOT/lib);$LIB"
...
category: Desktop
requires: msvcrt2019 base qt6-libs qca-qt6 qtkeychain-qt6-libs qt6-oci qgis-dev sqlite3 $RUNTIMEDEPENDS
EOF
...
path %OSGEO4W_ROOT%\\apps\\$P\\bin;%OSGEO4W_ROOT%\\apps\\qgis-dev\\bin;%PATH%
